...
if __name__ == '__main__':
    ...
    parser.add_argument("-qf", type=str2bool, nargs="?", const=True, default=False)
    parser.add_argument("-keywords", type=str, default=None, required=False) # if keywords are not supplied, TFIDF will be used
    parser.add_argument("-contrastive", choices=['none', 'binary', 'multi'], default="none")
    parser.add_argument('-intensity', default=1.0, type=float)
    
    parser.add_argument("-bertscore", type=str2bool, nargs="?", const=True, default=False)
    parser.add_argument("-aspect", type=str2bool, nargs="?", const=True, default=False)

    parser.add_argument('-name', default="somename", type=str)
